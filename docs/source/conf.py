...
apidoc_excluded_paths = ['setup.py', 'redis_ipc_msg_test.py']
...
exclude_patterns = ['_build', 'redis_ipc_msg_test', 'setup']
...
latex_documents = [
  (master_doc, 'redis_ipc.tex', 'redis\\_ipc Documentation',
   [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'redis_ipc', 'redis\\_ipc Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'redis_ipc', 'redis\\_ipc Documentation',
   author, 'redis_ipc', 'A set of redis_ipc client server classes',
   'Miscellaneous'),
]
